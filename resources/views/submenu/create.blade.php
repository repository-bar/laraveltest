                        ...
                        @endif
                          <form action="{{ route('submenus.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan Judul Sub Menu" value="{{ old('title') }}" name="title" id="title" required>
                            </div>
                            <div
                            <div class="form-group">
                                <label for="kategori">Pilih Menu</label>
                                <select class="form-control" name="category" id="category" required>
                                    <option value="">Pilih Menu Dari Sub Menu</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="summary-ckeditor" name="content">{{ old('summary-ckeditor') }}</textarea>
                            </div>
                        </div>
